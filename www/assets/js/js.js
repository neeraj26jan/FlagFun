...
/*$(function(){*/
    ...
    var App = {
        ...
        rebuildDomView : function() {
            ...
            $(vars.DOM_MESSAGE_WIN).find('div').html( vars.URIdata.totalPoints +" points");            
        ...
        listenerButtonsAlphabet : function() {
            ...
            function isLevel1(el) {
                ...
                if (attribute.length > 0) {
                    ...
                    $(vars.DOM_MESSAGE_WIN).find('div').html( totalPointsQuery +" points");                       
                    //console.log(vars.URIdata);
            ...
            function isLevel3(el) { 
                ...
                if (attribute.length > 0) {
                    ...
                    if (vars.URIdata.life==0) {
                        $(vars.DOM_FOOTER).before( '<p class="text-message-loser">You lost your 3 lives. Try again!</p>' );
                        flagHome = true;
                        //alert("perdiste");
                        setTimeout(function() {
